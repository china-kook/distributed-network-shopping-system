...
<div class="login_main clear">
    <div class="pic">
        <a href="javascript:void(0)" target="_blank"><img
                src="/images/6aca76574372d473c8a07e38a0b32ca2.png"></a>
    </div>
    <!-- login -->
    <div class="login">
        ...
        <div class="login_box clear">
            <ul class="loginnav">
                <li class="curr" mark="sfbest"><em></em>宜立方账号</li>
            </ul>
                ...
                <ul>
                    <form id="formlogin" method="post">
                        ...
                        <li style="display:none;"><span class="title">BGCode</span>
                            <span class="border">
						     <input type="hidden" name="bgcode" id="bgcode" value="sfbest"
                                    class="loginText">
                        ...
                        <li><span class="title">手机/验证邮箱/用户名<font style="padding-left:20px"
                                                                 class="error_line"
                                                                 color="#ff0000"></font></span>
                            <span class="border" style="position:relative">
						<input id="username" name="username" type="hidden" accesskey="n" value=""
                               size="25" autocomplete="off">
						<input class="new-input1 new-color" tabindex="1" data-clear-btn="true"
                               id="loginname" size="25" autocomplete="off" htmlescape="true"
                               title="请输入用户名">
...
<!-- /login_main -->
<div class="footer">
		<span> <a href="javascript:void(0)" rel="nofollow" class="footerlink1">关于我们</a> | <a
                href="javascript:void(0)" rel="nofollow" class="footerlink1">联系我们</a> | <a
                href="javascript:void(0)" rel="nofollow" class="footerlink1">招聘人才</a> | <a
                href="javascript:void(0)" rel="nofollow" class="footerlink1">友情链接</a> | <a
                href="javascript:void(0)" rel="nofollow" class="footerlink1">供应商申请</a>
		</span>
    <p>
        青岛宜立方电子商务有限公司<br> 北京市公安局顺义分局备案11011302000890号|<a href="http://www.miibeian.gov.cn"
                                                         target="_blank" rel="nofollow"
                                                         class="footerlink1">京ICP备12011349号</a>
        <br>Copyright© 宜立方商城
        e3mall.cn 版权所有<br>
    </p>
</div>
            ...
            $.post("/user/login", $("#formlogin").serialize(), function (data) {
                if (data.status == 200) {
                    jAlert('登录成功！', "提示", function () {
                        if (redirectUrl == "") {
                            location.href = "http://www.e3mall.cn";
                        } else {
