        ...
        $(".p-btn a,.rankBtn a,.rushBuy").live("click", function () {
            ...
            if (typeof(indexFlag) == "undefined") {
                if (typeof(freshFlag) == "undefined") {
                    //其它页面商品添加购物车
                    setTimeout(function () {
                        cartAdd(sfAddCart.pid, 0, 1, 5);
                    }, 100);
                } else {
                    //生鲜频道页商品添加购物车
                    setTimeout(function () {
                        cartAdd(sfAddCart.pid, 0, 1, 13, 1, This);
                    }, 100);
                }
                ...
                //首页页商品添加购物车
                setTimeout(function () {
                    cartAdd(sfAddCart.pid, 0, 1, 7, 1, This);
                }, 100);
            }
        });
    },
            ...
            success: function (msg) {
                if (msg.error == 1) {//成功
                    ...
                    if (0 == flag) {
                        ...
                        var animate_gap = -80;
                        var offsetEndTop = $(".side-panel").offset().top,
                            offsetEndLeft = $(".side-panel").offset().left - 20;
