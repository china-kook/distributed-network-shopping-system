...
<div class="slide_show" id="slide_show">
        ...
        <div id="index_slide" class="slide_wrap">
            <ol>
                <c:forEach items="${ad1List}" var="node" varStatus="status">
                    <li>
                        <a name="sfbest_hp_hp_focus_${status.index + 1 }" class="fore_pic trackref"
                           href="${node.url }" target="_blank">
                            <img id="lunbo_${status.index + 1 }" alt="${node.title }" src="${node.pic }">
                        </a>
                    </li>
                </c:forEach>
            </ol>
    ...
    <div class="indexbg" id="indexbg">
        <dl style="left: -1903px;">
            <dd style="background: rgb(196, 36, 41); width: 1903px;"></dd>
            <dd style="background: rgb(239, 54, 69); width: 1903px;"></dd>
            <dd style="background: rgb(66, 170, 107); width: 1903px;"></dd>
            <dd style="background: rgb(255, 122, 94); width: 1903px;"></dd>
            <dd style="background: rgb(213, 40, 47); width: 1903px;"></dd>
            <dd style="background: rgb(202, 148, 120); width: 1903px;"></dd>
            <dd style="background: rgb(255, 202, 44); width: 1903px;"></dd>
            <dd style="background: rgb(209, 89, 165); width: 1903px;"></dd>
        </dl>
    </div>
</div>
<!----row1 end------->
        ...
        <div class="rSide1">
            ...
            <div class="rImg2">
                <a name="sfbest_hp_hp_news_right-ad" class="trackref"
                   href="javascript:void(0)" target="_blank"><img salt="9.2-9.5"
                                                                              src="/images/goods/751d2091c008c2a49c1934545730f041.jpg"></a>
            </div>

            <div class="sfNews">
                <div class="rTitle"><h2>最新动态</h2><a href="javascript:void(0)" target="_blank" class="more">更多&gt;</a>
                </div>
                <ul>
                    <li><a name="sfbest_hp_hp_news_1" href="javascript:void(0)" target="_blank"
                           class=" red trackref" title="关于上合峰会青岛地区客户订单的影响">关于上合峰会青岛地区客户订单的影响</a>
                    </li>
                    <li><a name="sfbest_hp_hp_news_2" href="javascript:void(0)" target="_blank"
                           class=" trackref" title="购买燕麦片满49元抽奖活动中奖公告">购买燕麦片满49元抽奖活动中奖公告</a></li>
                    <li><a name="sfbest_hp_hp_news_3" href="javascript:void(0)" target="_blank"
                           class=" trackref" title="满299抽iPhoneX活动中奖公告">满299抽iPhoneX活动中奖公告</a>
                    </li>
                    <li><a name="sfbest_hp_hp_news_4" href="javascript:void(0)" target="_blank"
...
<div class="indexW mt2 full_ad" style="width:1190px;padding-left:10px;"><a
        name="sfbest_hp_hp_banner_1" class="trackref" href="javascript:void(0)"
                ...
                <h2>
                    ...
                    <a name="sfbest_hp_hp_floor1_floor-category1" class="trackref"
                       ...
                       target="_blank">水果</a>&nbsp;&nbsp;<a
                        ...
                        href="javascript:void(0)" target="_blank">蔬菜</a>
                </h2>
            </li>
        </ul>
        ...
        <div class="redge">
            <ul class="rHot">
                ...
                <li><a name="sfbest_hp_hp_floor1_Keywords8" class="trackref"
                       href="javascript:void(0)" target="_blank">加工蔬菜</a></li>
                <li><a name="sfbest_hp_hp_floor1_Keywords9" class="trackref"
                       href="javascript:void(0)" target="_blank">加利利</a></li>
            </ul>
            <div class="clr"></div>
            <div class="rimg">

                <a name="sfbest_hp_hp_floor1_right-ad" class="ht1 trackref"
                   href="javascript:void(0)" target="_blank"><img alt="8.30-9.5"
                                                                              class="lazy"
                                                                              ...
                                                                              style="display: inline;"></a>
                <div class="rbutton"><a href="javascript:void(0)" target="_blank"></a>
                </div>
            </div>
        </div>
    </div>
