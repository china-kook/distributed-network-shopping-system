        ...
        <div data-options="region:'center'" style="padding:5px">
            <table class="easyui-datagrid" id="contentList"
                ...
                <tr>
                    ...
                    <th data-options="field:'url',width:60,align:'center',formatter:E3.formatUrl">
                        内容连接
                    </th>
                    <th data-options="field:'pic',width:50,align:'center',formatter:E3.formatUrl">
                        图片
                    </th>
                    <th data-options="field:'pic2',width:50,align:'center',formatter:E3.formatUrl">
                        图片2
                    </th>
